...
class Element7 extends Widget_Base{
  ...
  ?>
        ...
        <a class="blue-btn" href="<?php echo $settings['button_link']['url'] ?>" <?php echo $target.$nofollow ?>  <?php echo $this->get_render_attribute_string('button_title'); ?>><span  style="padding-right:5px;"><i class="<?php echo $settings['icon'] ?>" aria-hidden="true"></i></span><?php echo $settings['button_title']?></a>
      <?php
    }
    ...
    #>
    <a class="blue-btn" onclick="{{{ settings.button_link.url }}}"{{ target }}{{ nofollow }}><span style="padding-right:5px;"><i class="{{settings.icon}}" aria-hidden="true"></i></span>{{ settings.button_title }}</a>
        <?php
    }
}
